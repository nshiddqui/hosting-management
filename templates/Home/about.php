    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 text-center">
                <h1 class="display-2 mb-3">Who is Yuserver for?</h1>
                <p class="lead">Whether you’re a programmer, designer, freelancer or need Yuserver for a whole team our pricing just makes sense.</p>
            </div>
        </div>
    </div>
